...
const FIXED_ROLES = {
  ...
  POP_SAMPLES: 'population-chart history length (`SAMPLE_DT` per sample)',
  SAMPLE_DT: 'sim-time spacing between population-history samples; fixed so the charts span a constant sim-time window at any speed',
