...
export const PARAM_DEFS = [
  ...
  { key: 'PRED_REORIENT', group: 'predator', label: 'Reorient time', desc: 'Seconds after finishing a meal that a red steers at the nearest prey and ignores the ambush coast (0 = off).', def: 0.3, min: 0, max: 2, step: 0.05 },
